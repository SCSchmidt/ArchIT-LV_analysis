...
- Unterscheidung: Studierende haben Chance drauf (alle Angebote) und wird am Institut angeboten
...
# TODO: Farben nach Themen zuordnen (so dass genaue Unterscheidung möglich, wenn gewünscht, aber ansonsten auch einfach ein Eindruck möglich wird)
```
...
### TODO : doch lieber richtige heatmap?
#LV_inh_st |>
#  ggplot(aes(x = fct_rev(fct_infreq(Stadt) )) )+
#  geom_bar(aes(y = n,
#               fill = Inhalt ),
#           position = "fill",
#           stat = "identity" ) +
#  labs(title = "Schlagworte zur Beschreibung der Kursinhalte nach Stadt",
#       y = "Prozent der Schlagworte auf Stadt",
#       x = "",
#       fill = "")+
 #geom_text(aes(y = 1,
#                label = sum(n) ) ) +
